...
2. **Deploy + clear caches**: After deploying, run `php artisan optimize:clear` (or equivalent) on the server so routes/config changes take effect.# Budgeter 2026 - Project Roadmap
